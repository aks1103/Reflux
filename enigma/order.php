...
if(!isset($_GET['name']) || !isset($_GET['phone']) || !isset($_GET['mail'])){
	...
	$sql = 'SELECT id  FROM enigma_participants WHERE email = "'.$mail.'"';
  ...
  <body>
    <div class="container" style="width: 60%;margin: auto;">
      ...
      <div class="page-header">
		...
		<hr>
		<form action="pay.php" method="POST" accept-charset="utf-8" id="form">

		...
		<div class="slides">
			...
			<section>
				...
				<ul>
					...
					<li><font size="5"><button class="btn2" disabled>Save And Next</button> use this to Save the question and continue.<b>Questions saved will only be evaluted.</b></font></li>

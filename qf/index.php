...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST)){
  ...
  $sql = 'INSERT INTO enigma_participants '.'( name, email, phone ) '.'VALUES ("' . $name . '","' . $email . '","' . $phone . '")';
  ...
  if ($db->query($sql) === TRUE) {
   ...
   if ($retval->num_rows == 1) {
      while($row = $retval->fetch_assoc()) {
          ...
          $confirmlink = "http://quiz.reflux.in/confirm.php?e=$email&c=$confirm";
...
<div class="register-box">
  <div class="register-logo">
    <img src="logo.png" style="width: 13vw;" />
  </div>
...
<!-- /.register-box -->
<div style="position:fixed;bottom:0px;"><img src="http://quiz.reflux.in/sponsors.png" style="width:100%;height:13vh;"/></div>
